...
from typing import Final, TextIO, TypedDict, Unpack, cast, get_args, override
...
from test_map_linux_py312_test import __version__
from test_map_linux_py312_test.cli import APP_NAME, __app_name__
from test_map_linux_py312_test.cli.logs import LogLevel, configure_logging
from test_map_linux_py312_test.loc import _


__all__: Final = ["test_map_linux_py312_test"]
...
def print_license(ctx: Context, _param: Option, value: bool) -> None:
    ...
    console = importlib.import_module("test_map_linux_py312_test.console")
    package_metadata = importlib.import_module(
        "test_map_linux_py312_test.package_metadata"
    )
...
def test_map_linux_py312_test(**kwargs: Unpack[CLIArgsType]) -> None:
    """The Whiteprint CLI."""
    configure_logging(
